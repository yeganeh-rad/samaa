                        ...
                        <div className="col-md-12 leftBorder bottomBorder">
                            <div className="row">
                                <div className="col-md-12 bottomBorder">
                                    ...
                                    <div className="row">
                                        <div className="col-md-7 title-x-large"> <i class="fas fa-user"></i>لیست اشخاص</div>
                                        <div className="col-md-5">
                                            <div class="add-butt-holder">
                                                < a class="add-butt" href="" onClick={this.submitFinal}> <i class="far fa-plus-square"></i>شخص جدید </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                ...
                                <div className="col-md-12">
                                    <div className="row">
                                        <div className="col-md-7 title-x-large">
                                            <i class="fas fa-file-invoice"></i>لیست درخواست ها
                                        </div>
                                        <div className="col-md-5">
                                            <div class="add-butt-holder">
                            ...
                            <div class="row topBorder">
                                <div class="col-md-6">
                                    <div class="login-signup">
                                        <a class="go-butt" href="" onClick={this.submitChangeHandler}><i class="far fa-save"></i>ارسال به بانک </a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="login-signup">
                                        <a class="go-butt" href="" onClick={this.submitChangeHandler}> <i class="fas fa-external-link-alt"></i>خروج </a>
                                    </div>
                                </div>
                            </div>
                        </div>
